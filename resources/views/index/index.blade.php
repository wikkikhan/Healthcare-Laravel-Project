            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        ...
                        <a class="navbar-brand" href="#">Health<span>care</span></a>
                    ...
                    <div class="banner_text">
                        <div class="banner_text_iner">
                            <h1>Bringing the future
                                of healthcare</h1>
                            <p>Suspendisse consequat nisi tellus, at ornare urna euismod sed. Curabitur at posuere nunc. Duis a convallis nulla, vitae molestie justo. Aenean lobortis massa non elementum mollis. Morbi fringilla quam id sapien dignissim fermentum. </p>
                            <a href="{{URL::to('/aptmntcreate')}}" class="btn_2">Make an appointment</a>
                ...
                <div class="col-md-6 col-lg-5">
                    <div class="our_ability_member_text">
                        ...
                        <ul>
                            ...
                            <li><span class="ti-package"></span>Experienced Doctors</li>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="single_blog_item">
                        ...
                        <div class="single_text">
                            <div class="single_blog_text">
                                <h3>DR Waqar Ahmad</h3>
                                <p>Neurologists specialist</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-3">
                    <div class="single_blog_item">
                        ...
                        <div class="single_text">
                            <div class="single_blog_text">
                                <h3>DR Hassan khan</h3>
                                <p>Cardialogists specialist</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-4 col-xl-4">
                    <div class="single-home-blog">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <ul>
                                    <li> <span class="ti-user"></span>Talha khan</li>
                ...
                <div class="col-sm-6 col-lg-4 col-xl-4">
                    <div class="single-home-blog">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <ul>
                                    <li> <span class="ti-user"></span>Ubaid khan</li>
                                    <li> <span class="ti-bookmark"></span>Clinic, doctors</li>
                                </ul>
                                <a href="blog.html">
                                    <h5 class="card-title">Appear have grass man fill after
                ...
                <div class="col-sm-6 col-lg-4 col-xl-4">
                    <div class="single-home-blog">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <ul>
                                    <li> <span class="ti-user"></span>Waqar Ahmad</li>
                                    <li> <span class="ti-bookmark"></span>Clinic, doctors</li>
                                </ul>
                                <a href="blog.html">
                                    <h5 class="card-title">Appear have grass man fill after
